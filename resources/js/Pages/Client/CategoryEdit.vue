        ...
        <section class="container p-6 mx-auto">
            ...
            <div  class="mt-10 mb-20 p-4 md:p-7 mx-auto rounded bg-white shadow-lg">
                <form @submit.prevent="submit">
                    <h2 class="mb-5 text-2xl font-semibold">Update</h2>
                    ...
                    <button type="submit" class="px-4 py-2 text-center w-full inline-block text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700" href="#">  Update </button>
    ...
    export default {
        ...
        setup (props) {
            const form = reactive({
                ...
                navbar: props.category.show_on_navbar
            })

            function submit() {
                Inertia.post('/client/categories/'+props.category.id+'/update', form)
            }
